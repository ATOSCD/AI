...
# 🔹 원천 이미지 폴더
image_folder = r"C:\Users\user\Downloads\037.Small_object_detection을_위한_이미지_데이터\01.데이터\1.Training\1.원천데이터\mnt\nas2\Projects\TTA_2022_jgcha\jhbae\037.Small object detection을 위한 이미지 데이터\01.데이터\1.Training\1.원천데이터\TS_주방_다이닝룸dining_room01"
